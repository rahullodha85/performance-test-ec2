package hbc_commonStack.chains.searchText
...
/**
  ...
  */
object TextSearch extends commonStack {
  ...
  def TextSearch = group("TextSearch_Transaction") {
    feed(SearchString)
      .exec(http("lookahead_json")
        .get(baseHttpUrl + "/search/lookahead_json.jsp?callback=jQuery172012264395567273178_1458054414738&term=${SearchString}&_=1458054490227")
        .check(status.is(200))
      )
