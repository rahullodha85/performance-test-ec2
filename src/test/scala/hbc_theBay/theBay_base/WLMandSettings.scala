...
trait theBaySettings {
  lazy val SearchString = jsonFile("src/test/resources/data/hbc_newbay/SearchString.json").random
  lazy val BillingDetails = jsonFile("src/test/resources/data/hbc_newbay/BillingDetails.json").circular
  lazy val ShippingDetails = jsonFile("src/test/resources/data/hbc_newbay/ShippingDetails.json").circular
  lazy val changeQty = jsonFile("src/test/resources/data/hbc_newbay/ChangeQty.json").circular
  lazy val userInfo = jsonFile("src/test/resources/data/hbc_newbay/UserInformation.json").random
  lazy val BayLinks = jsonFile("src/test/resources/data/hbc_newbay/UserInformation.json").random
}

trait theBayLoadSettings {
...
trait theBayWLM {
  ...
  val config = ConfigFactory.load("data/hbc_newbay/WLM")
